...
>  **Совет:** Запустите приложение (`mvn spring-boot:run`) и откройте локальную версию Swagger UI для тестирования всех эндпоинтов в реальном времени или откройте глобальную версию(запуск не требуется).
...
|------------|-----|-------------------------------------------------------|
| **Swagger UI** | http://localhost:8080/swagger-ui.html | Локальное интерактивное тестирование всех эндпоинтов  |
| **Swagger UI** | https://messenger-api.ru/swagger-ui/index.html | Глобальное интерактивное тестирование всех эндпоинтов |
